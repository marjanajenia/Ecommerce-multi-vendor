...
<div class="br-pagebody">
    <div class="#card">
        ...
        <div class="card-header">
            <h4>All Category <a class="btn btn-info btn-sm" href="" style="float: right;" data-toggle="modal" data-target="#addcategory">Add Category</a></h4>
        </div>
        <!-- category add Modal -->
                ...
                <div class="modal-body">
                    ...
                    <form method="post" action= ""id="categoryData" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="category_des" id="category_des" rows="4" placeholder=" Enter your Category Drescreption"></textarea>
                    ...
                    {{--  <tbody class="tbodydata">
                        @foreach($categoryData as $category)
                         <tr>
                            ...
                            <td><img width="70px" height="50px" src="{{asset('backend/img/'.$category->image)}}" alt="category"></td>
                            <td>
                           ...
                           <td>
                            <button type="button" value="{{$category->id}}" data-target="#catEditModal" data-toggle="modal" class="catEdit btn btn-sm btn-info"><i class="fa fa-edit"></i></button>
                            <button type="button" value="{{$category->id}}" id="" class="catDelete btn btn-sm btn-danger"><i class="fa fa-trash"></i></button>
                           </td>
                        </tr>
                        @endforeach
                    </tbody>  --}}
                ...
                <div class="modal-body">
                    ...
                    <form method="post" id="editcategoryData" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="category_update_name" id="eidit_category_name" placeholder=" Enter your Category Name">
                          <span class="text-danger catUpdateNameError"></span>
                        </div>
                        <div class="form-group">
                            <label for="eidit_category_des">Category Drescreption</label>
                            <textarea class="form-control" name="category_update_des" id="eidit_category_des" rows="4" placeholder=" Enter your Category Drescreption"></textarea>
                            <span class="text-danger catUpdateNameDesError"></span>
                        </div>
                        <div class="form-group">
                            <label for="category_img">Category Image</label>
                            <input type="file" name="category_update_img" class="form-control" id="category_img">
